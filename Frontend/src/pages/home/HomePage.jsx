...
function HomePage() {
  ...
  const handleClick = () => {
    window.open(
      "https://resumegenie-ai.vercel.app",
      "_blank"
    );
  };
        ...
        <div className="px-12 mx-auto max-w-7xl">
          <div className="w-full mx-auto text-left md:w-11/12 xl:w-9/12 md:text-center">
            ...
            <p className="px-0 mb-8 text-lg text-gray-600 md:text-xl lg:px-24">
              Create ATS-friendly, recruiter-ready resumes in minutes with our AI-Powered Resume Builder & Optimizer.
            </p>
            <div className="mb-4 space-x-0 md:space-x-2 md:mb-8">
              ...
              >
                 {user && Object.keys(user).length > 0 ? "Build Resume" : "Get Started"}
                <svg
      ...
      <footer className="bg-white" aria-labelledby="footer-heading">
        <div className="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24 p-5 flex justify-between">
          <p className="text-xs leading-5 text-gray-500">
            &copy; 2025 ResumeGenie-AI. All rights reserved.
          </p>
        </div>
      </footer>
    </>
